...
\begin{subequations}
    \begin{alignLsub}
        q_{B_j}^t &\in \left[-\sqrt{3} (P_{B_j}^t + S_{B_{R, j}}), -\sqrt{3} (P_{B_j}^t - S_{B_{R, j}})\right] \label{eq:batreact-L-a} \\
        q_{B_j}^t &\in \left[-\frac{\sqrt{3}}{2} S_{B_{R, j}}, \frac{\sqrt{3}}{2} S_{B_{R, j}}\right] \label{eq:batreact-L-b} \\
        q_{B_j}^t &\in \left[\sqrt{3} (P_{B_j}^t - S_{B_{R, j}}), \sqrt{3} (P_{B_j}^t + S_{B_{R, j}})\right] \label{eq:batreact-L-c}
    \end{alignLsub}
\end{subequations}
