...
\begin{table}[t] % BFM-NL vs LinDistFlow for 24 h 
    ...
    \begin{tabular}{|l|c|c|}
    \hline
    \textbf{Metric} & \textbf{BFM-NL} & \textbf{LinDistFlow\textsuperscript{\(\mathbb{O}\)}
    } \\ \hline
    Largest subproblem & \multicolumn{2}{c|}{} \\ \hline
    \quad Decision variables & {0000} & {12096} \\ \hline
    \quad Linear constraints & {0000} & {22200} \\ \hline
    \quad Nonlinear constraints & {0000} & {0} \\ \hline
    Simulation results  & \multicolumn{2}{c|}{} \\ \hline
    \quad Substation power cost (\$) & 0000 & 2798.4 \\ \hline
    \quad Substation real power (kW) & 0000 & 21065.89 \\ \hline
    \quad Line loss (kW) & 0000 & 461.38 \\ \hline
    \quad Substation reactive power (kVAR) & 0000 & 12259.29 \\ \hline
    \quad PV reactive power (kVAR) & 0000 & 195.12 \\ \hline
    \quad Battery reactive power (kVAR) & 0000 & 204.63 \\ \hline
    Computation  & \multicolumn{2}{c|}{} \\ \hline
    \quad Number of Iterations & 0000 & 1 \\ \hline
    \quad Total Simulation Time (s) & 0000 & 0.85 \\ \hline
    \end{tabular}
