...
\begin{table}[t]
    ...
    \quad Substation power cost (\$) & 0000 & 204.28 \\ \hline
    \quad Substation real power (kW) & 0000 & 1528.4 \\ \hline
    \quad Line loss (kW) & 0000 & 0.33 \\ \hline
    \quad Substation reactive power (kVAR) & 0000 & 795.56 \\ \hline
    \quad PV reactive power (kVAR) & 0000 & -0.69 \\ \hline
    \quad Battery reactive power (kVAR) & 0000 & -0.37 \\ \hline
    Computation  & \multicolumn{2}{c|}{} \\ \hline
    \quad Number of Iterations & 0000 & 1 \\ \hline
    \quad Total Simulation Time (s) & 0000 & 0.77 \\ \hline
    \end{tabular}
...
\begin{table}[t]
    ...
    \quad Voltage (pu) & 0000 & 0.00001 \\ \hline
    \quad Line loss (kW) & 0000 & 0.000006 \\ \hline
    \quad Substation power (kW) & 0000 & 0.02410 \\ \hline
    \quad Substation reactive power (kVAR) & 0000 & 0.05618 \\ \hline
    \end{tabular}
